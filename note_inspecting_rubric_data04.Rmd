...
###PLO1
Both internal/external use Peregrine test

### PLO2 Annotated bibliography (rubric--milestone in company profile)
```{r}
x <- tbl %>%
...
### PLO3 Company profile, rubric graded project.  Rubric rows  PLO3 a, b, c, d, e
...
### PLO4 BUS 499 Capstone Simulation, AAR Rows PLO4 a, b
```{r}
x <- tbl %>%
