...
Now here's the different step. Merging partial data for each prgram serves little purpose. Just have all the new results. Then, merge it into the whole history.

For graph, I can select relevant results.


For this purpose, it's better if I can have outcomes to be compatible with the existing data.
