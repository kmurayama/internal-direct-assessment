...
tbl2 <- non %>% transmute(Course, Section, Semester, Assessment, Name = "No Rubric", PLO, Met.UND = np/n, Met.GRD = Met.UND, n, Rubric = FALSE)
...
It would be straight forward to add 2019 data with sufficient information, rather than selecting relevant rows...?
