...
lplt <- list()
for(prog in c("Accounting", "Business Core", "Economics", "Finance",
              "Human Resources Management", "Marketing", "Management", "MBA")){
...
- [x] Accounting: All clear except PLO 3, whose course was *actually* taught by Hina Chawdhry. Ed has requested an access, so it should be available soon.
- [x] Business Core: All clear.
- [x] Economics: All clear. (Paul will need to make the mapping more explicit, but that’ll be a task for the next round.)
- [x] Finance program: All clear. (Chris told me that he actually didn’t use rubrics for FIN 302. I asked him to assess outcomes from the records and his memory.)
- [x] Human Resources Management: All clear.
- [x] Management: All clear.
- [x] Marketing: All clear. Mapped available data into PLOs (by Rich).
- [x] MBA: All clear. PLO 5 course was not offered.
- [x] MIS: The course (MIS 401 or MGT 373) was not offered this term. Confirmed.
