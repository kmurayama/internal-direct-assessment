...
Visualize
--------------------------------------------------------------------------------
Now that all the outcomes are in one place. I can simply filter relevant results and visualize them.
...
```{r}
x <- out2019 %>%
  filter(Program == "Accounting", `Assessment Type Orientation` == "Internal",
         `Assessment Type` == "Summative")
draw_graph(x)
```
```{r}
x <- out2019 %>%
  filter(Program == "Business Core", `Assessment Type Orientation` == "Internal",
         `Assessment Type` == "Summative")
draw_graph(x)
```
```{r}
x <- out2019 %>%
  filter(Program == "Economics", `Assessment Type Orientation` == "Internal")
draw_graph(x)
```
