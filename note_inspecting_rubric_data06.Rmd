...
merge_outcomes <- function(lres, program){
  ...
  y <- past %>%
    filter(Program == program, `Assessment Type` == "Internal",
...
FIN 711 for MBA 3, missing. ...Wait. It should be from 401. Eric Freeman taught and answered. ...So, there's no assessment?
